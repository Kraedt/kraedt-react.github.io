...
export const getMusicItemImage = (item: any) => item.imageUrl?.startsWith("http") ? getDriveImage(item.imageUrl) : (isNullOrWhitespace(item.imageUrl) ? NoImage : (songImages[item.imageUrl] ?? NoImage));
